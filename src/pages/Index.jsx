      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <ul className="grid grid-cols-2 gap-4">
            <li className="bg-gray-100 p-3 rounded">Siamese</li>
            <li className="bg-gray-100 p-3 rounded">Persian</li>
            <li className="bg-gray-100 p-3 rounded">Maine Coon</li>
            <li className="bg-gray-100 p-3 rounded">British Shorthair</li>
          </ul>
        </div>
      </div>
    </div>
